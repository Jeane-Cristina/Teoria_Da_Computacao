 ...
 * Programa Didatico de Criptografia Assimetrica
   * Demonstra RSA: geracao de chaves, cifracao e assinatura digital
...
public class CriptografiaAssimetrica {
    ...
    public static void main(String[] args) throws Exception {
          ...
          // 3. Decifrar com chave privada
          System.out.println("\n3. Decifrando com chave PRIVADA...");
              ...
              System.out.println("   Sucesso: " + mensagemOriginal.equals(mensagemRecuperada));
          ...
          System.out.println("\n" + "=".repeat(60));
              System.out.println("Conceito: RSA baseado na dificuldade de fatorar numeros grandes");
              System.out.println("Algoritmo de Shor (quantico) ameaca o RSA - use PQC no futuro!");
              System.out.println("Bitcoin/Ethereum usam ECDSA (curvas elipticas) para assinaturas");
    }
}
