...
# Usando apenas a biblioteca padrao do Python

def xor_encrypt(text, key):
      """Cifra XOR simples para demonstracao"""
...
print("Conceitos: mesma chave para cifrar e decifrar")
print()
...
print("Conceito: A seguranca esta na CHAVE, nao no algoritmo (Principio de Kerckhoffs)")
print("AES-256 com chave de 256 bits tem 2^256 combinacoes possiveis")
print("Computacao quantica (Grover): reduz para 2^128 - ainda muito seguro!")
